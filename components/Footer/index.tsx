...
const Footer: FC = () => {
  return (
    <Box px={6} py={8} bg={'linear-gradient(to top, rgba(0, 191, 77, 1) 0%, rgba(2, 153, 62, 1) 100%)'} >
      <Box  w={"85%"}  mx={'auto'}>
        <Grid templateColumns={{base: 'repeat(1, 1fr)', lg: 'repeat(5, 1fr)'}} gap={6} mt={12} mb={12}>
          <Box as={GridItem} colSpan={2} textAlign={{base:'center', lg: 'left'}} mb={12}>
        ...
        <Flex mt={4} mb={4} direction={'column'} align={{base: 'center', lg:'flex-end'}}>
          <Flex>
        ...
        <Flex justifyContent="space-between" align={'center'} mt={4} direction={{base: 'column-reverse', lg: 'row'}}>
